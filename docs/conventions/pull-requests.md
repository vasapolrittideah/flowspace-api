...
- Before creating or updating a PR description, reread the [Markdown rules](markdown-and-prose.md#markdown). Review each prose section before submitting the description. If a section contains separate points, split them into paragraphs or bullets.
