...
- Name ports for the capability they expose. Add a port only when application code needs that boundary. Keep generated Protobuf names and generated database code as produced by their tools.
